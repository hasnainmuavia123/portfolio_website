  ...
  if (filtered.length === 0) {
    grid.innerHTML = `
      <div style="grid-column: 1 / -1; text-align: center; padding: 40px; color: var(--text-secondary);">
        <i class="fa-solid fa-folder-open" style="font-size: 2rem; margin-bottom: 12px; color: var(--accent-orange);"></i>
  ...
  filtered.forEach((project, index) => {
    ...
    const actionsHtml = project.isConfidential
      ? `<div class="project-actions">
          <span class="btn btn-nda" title="Proprietary codebase protected under Enterprise NDA">
            <i class="fa-solid fa-lock"></i> Proprietary / Enterprise NDA
          </span>
