    ...
    for (let a = 0; a < this.particles.length; a++) {
      for (let b = a + 1; b < this.particles.length; b++) {
        ...
        if (distance < maxDistance) {
          ...
          this.ctx.strokeStyle = `rgba(255, 120, 30, ${opacity})`;
...
class Particle {
  constructor(width, height) {
    ...
    // Ambient orange/amber or subtle cyan
    this.isAmber = Math.random() > 0.35;
    this.color = this.isAmber ? 'rgba(255, 120, 30, ' : 'rgba(255, 180, 80, ';
